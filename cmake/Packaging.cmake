...
if(WIN32 AND XCHPLOT2_PACKAGE_GPU STREQUAL "intel")
    message(FATAL_ERROR "Windows runtime packaging supports NVIDIA and AMD; Intel is not yet packaged")
endif()
...
if(WIN32)
    ...
    install(FILES ci/release/install-dependencies.ps1 DESTINATION .)
...
set(CPACK_PACKAGE_FILE_NAME "xchplot2-${PROJECT_VERSION}-${_release_system}-x86_64-sycl-${XCHPLOT2_PACKAGE_GPU}")
