...
if(NOT XCHPLOT2_PACKAGE_GPU STREQUAL "all")
    message(FATAL_ERROR "SYCL packages must include all GPU backends (XCHPLOT2_PACKAGE_GPU=all)")
endif()
...
if(WIN32)
    ...
    set(_release_platform linux-x86_64-sycl)
endif()
