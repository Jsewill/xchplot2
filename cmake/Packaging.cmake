...
if(WIN32 AND NOT XCHPLOT2_PACKAGE_GPU STREQUAL "all")
    message(FATAL_ERROR "Windows SYCL packages must include all GPU backends (XCHPLOT2_PACKAGE_GPU=all)")
elseif(NOT WIN32 AND NOT XCHPLOT2_PACKAGE_GPU MATCHES "^(nvidia|amd|intel)$")
    message(FATAL_ERROR "XCHPLOT2_PACKAGE_GPU must be nvidia, amd, or intel")
endif()
if(NOT EXISTS "${XCHPLOT2_RUNTIME_DIR}/libacpp-rt.so" AND
   NOT EXISTS "${XCHPLOT2_RUNTIME_DIR}/acpp-rt.dll")
    message(FATAL_ERROR "Collect the AdaptiveCpp runtime first with scripts/build-release.sh or scripts/build-release.ps1")
endif()
...
if(WIN32)
    install(DIRECTORY "${XCHPLOT2_RUNTIME_DIR}/" DESTINATION bin)
...
if(WIN32)
    ...
    set(_release_platform windows-x86_64-sycl)
else()
    set(CPACK_GENERATOR TGZ)
    set(_release_platform "linux-x86_64-sycl-${XCHPLOT2_PACKAGE_GPU}")
endif()
set(CPACK_PACKAGE_NAME xchplot2)
set(CPACK_PACKAGE_VERSION "${PROJECT_VERSION}")
set(CPACK_PACKAGE_FILE_NAME "xchplot2-${PROJECT_VERSION}-${_release_platform}")
