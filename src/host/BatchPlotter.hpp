...
//                       Plotting on CPU is 1-2 orders of magnitude slower
//                       than on GPU; this is meant for headless CI / GPU-less
...
struct BatchOptions {
    ...
    int  cpu_workers       = 0;   // 0 = no CPU worker; N = N concurrent CPU plots
