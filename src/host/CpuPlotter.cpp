...
//     PARENT-DIRECTORY fsync + atomic rename. The hand-rolled guard that used
//     to live here did all of that except the directory fsync, so a power loss
//     right after the rename could still lose the directory entry.
//
