...
void print_usage(char const* prog)
{
    ...
    << "    --skip-existing                 : skip plots whose output file is already a\n"
        ...
        << "                                      tiny = ~1.5 GB target floor (sub-\n"
        << "                                      4 GB cards). Currently lands at\n"
        << "                                      ~minimal's overall peak because the\n"
        << "                                      T2 match phase peak is unchanged;\n"
        << "                                      tiny's T3 match peak drops further\n"
        << "                                      via fully-sliced section reads.\n"
